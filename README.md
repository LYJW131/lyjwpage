...
| **Pulse** | 编码、听、看、玩、充电、身体活动六个域最近 24 小时的活跃度泳道，听、看、玩直接显示二值状态与活跃时长，充电显示实测瓦数；编码和身体活动由 Jev 按五分钟窗口评分。 |
...
**Pulse**：六个域最近 24 小时的活跃度泳道，听、看、玩直接显示播放／游戏状态与 24 小时活跃时长，充电曲线和详情显示实测瓦数、右侧显示当前功率。仅编码和身体活动由 Jev 按五分钟窗口评分；历史每分钟归档到 D1。
