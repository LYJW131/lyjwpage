...
```bash
COPYFILE_DISABLE=1 tar czf - -C reporters --exclude node_modules --exclude dist --exclude .env discord-reporter | ssh misaka-jp 'mkdir -p /opt/lyjwpage && tar xzf - -C /opt/lyjwpage'
```
