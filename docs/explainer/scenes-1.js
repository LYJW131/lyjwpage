...
(() => {
  ...
  const LLM_TEXT = "好的，让我们一步一步来分析这个窗口标题。首先，我需要弄清楚这个标题来自哪个应用，以及它大概在描述什么内容。其次，我会结合常见的使用场景，想一想把它公开出去是否合适。为了稳妥起见，我们不妨先把各种可能的情况都列出来，再逐条权衡利弊：第一种情况，它可能只是一个普通的窗口名称；第二种情况，它也可能";
