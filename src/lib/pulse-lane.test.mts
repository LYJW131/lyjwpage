...
test("阶跃路径先竖后横，档位映射到高度", () => {
  ...
  assert.equal(area, "M0.00 30.00 L0.00 0.00 L5.00 0.00 L5.00 30.00 L100.00 30.00 L100.00 30.00 Z");
  assert.equal(line, "M0.00 0.00 L5.00 0.00 L5.00 30.00 L100.00 30.00");
});
